...
namespace KumoTransport.Controllers;
...
public class CmsController : Controller
{
  ...
  /// <param name="draft">If a draft is requested</param>
  [Route("kumohomepage")]
  public async Task<IActionResult> KumoHomePage(Guid id, bool draft = false)
  {
    try
    {
      var model = await _loader.GetPageAsync<KumoHomePage>(id, HttpContext.User, draft);
  ...
  /// <param name="draft">If a draft is requested</param>
  [Route("investors")]
  public async Task<IActionResult> InvestorPage(Guid id, bool draft = false)
  {
    try
    {
      var model = await _loader.GetPageAsync<InvestorPage>(id, HttpContext.User, draft);
